...
#define FONT_4x6     1
#define FONT_4x6_Mirrored 31
// #define FONT_5x7     2
// #define FONT_5x8     3
#define FONT_5x7W    4
#define FONT_5x7W_Mirrored 34
// #define FONT_6x10    5
// #define FONT_6x12    6
// #define FONT_6x13    7
// #define FONT_6x13B   8
...
//    void writebits (byte bits, byte len);
    ...
    byte putchar(uint8_t x, uint8_t y, char c, byte color = GREEN, byte attr = 0);
    void putbitmap(uint8_t x, uint8_t y, prog_uint16_t *bitmap, byte w, byte h, byte color);
    ...
    void putInt(uint8_t y, int num, byte color, boolean left);
